...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join categorie c  ON  p.refe= c.refe AND c.affichage='oui' AND p.categorie='piéces de rechange'  ";
    $search_result = filterTable($query);
}
            ...
            <div class="shop-sidebar-wrap col-xl-3 col-lg-4 col-12 order-lg-1 mb-15">
                ...
                <div class="shop-sidebar mb-35">
                    ...
                    <ul class="sidebar-brand">
                        <li><a href="couleurBP.php">Bleu</a></li>
                        <li><a href="couleurBLP.php">Blanc</a></li>
                        <li><a href="couleurRP.php">Rouge</a></li>
                        <li><a href="couleurNP.php">Noire</a></li>
                        <li><a href="couleurORP.php">Orange</a></li>
