...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join etoile e  ON  p.refe= e.refe inner join categorie c on  p.refe= c.refe  AND  e.nbetoile >'3' AND  c.affichage='oui' AND p.categorie='piéces de rechange'";
    $search_result = filterTable($query);
}
                        ...
                        <div class="shop-top-bar with-sidebar">
                            ...
                            <div class="product-short">
                                ...
                                <select name="sortby" class="nice-select"  onChange="location.href=''+this.options[this.selectedIndex].value+'.php';">
                                    ...
                                    <option value="tridescv">Price: high to low</option>
                                </select>
                            </div>
