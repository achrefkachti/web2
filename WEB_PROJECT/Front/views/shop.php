...
{
    var zip = parseInt(champ.value);
   if(isNaN(zip) || zip <1001 || zip >=2001)
   {
      surligne(champ, true);
      return false;
   }
                        ...
                        <div class="shop-top-bar with-sidebar">
                            ...
                            <div class="product-short">
                                ...
                                <select name="sortby" class="nice-select"  onChange="location.href=''+this.options[this.selectedIndex].value+'.php';">
                                    ...
                                    <option value="triasc">Price: low to high</option>
                                    <option value="tridesc">Price: high to low</option>
                                </select>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-12 pb-30 pt-10">
                        ...
                        <div class="ee-product">
                            ...
                            <div class="image">
                                ...
                                <a href="product-detail.php?id=<?php echo $row['refe'] ?>" class="img"><img src="<?PHP echo $row['img'];?>" alt="Product Image" style="width:270px;height:250px;"></a>
                                ...
                                <a href="ajouterpanier.php?refe=<?php echo $row['refe'];?>&nom=<?php echo $row['nom'] ;?>&prix=<?php echo $row['prix'];?>&img=<?php echo $row['img'] ;?>&quantite=<?php echo $row['quantite'] ;?>"  class="btn center btn-circle hover-theme ml-50 mt-10 mr-30 mb-30"><i class="ti-shopping-cart"></i><span>ADD TO CART</span></a>
            ...
            <div class="shop-sidebar-wrap col-xl-3 col-lg-4 col-12 order-lg-1 mb-15">
                ...
                <div class="shop-sidebar mb-35">
                    ...
                    <ul class="sidebar-brand">
                        <li><a href="couleurBL.php">Bleu</a></li>
                        <li><a href="couleurB.php">Blanc</a></li>
                        <li><a href="couleurR.php">Rouge</a></li>
                        <li><a href="couleurN.php">Noire</a></li>
                        <li><a href="couleurOR.php">Orange</a></li>
