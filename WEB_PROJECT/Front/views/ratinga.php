...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join etoile e  ON  p.refe= e.refe inner join categorie c on  p.refe= c.refe  AND  e.nbetoile >'3' AND  c.affichage='oui' AND p.categorie='accesoires'";
    $search_result = filterTable($query);
}
