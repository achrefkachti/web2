...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join categorie c  ON  p.refe= c.refe AND c.affichage='oui' AND p.categorie='velo'  ";
    $search_result = filterTable($query);
}
                        ...
                        <div class="shop-top-bar with-sidebar">
                            ...
                            <div class="product-short">
                                ...
                                <select name="sortby" class="nice-select"  onChange="location.href=''+this.options[this.selectedIndex].value+'.php';">
                                    ...
                                    <option value="ratingv">Best rated</option>
                                    <option value="triascv">Price: low to high</option>
                                    <option value="tridesv">Price: high to low</option>
                                </select>
                            </div>
...
<?php endwhile;
            ...
            <div class="shop-sidebar-wrap col-xl-3 col-lg-4 col-12 order-lg-1 mb-15">
                ...
                <div class="shop-sidebar mb-35">
                    ...
                    <form name="f" action="shop4.php" method="post">
                ...
                <div class="shop-sidebar mb-35">
                    ...
                    <h4 class="title">Couleur</h4>
                     ...
                     <ul class="sidebar-brand">
                        <li><a href="couleurBLV.php">Blanc</a></li>
                        <li><a href="couleurBV.php">Bleu</a></li>
                        <li><a href="couleurRV.php">Rouge</a></li>
                        <li><a href="couleurNV.php">Noire</a></li>
                        <li><a href="couleurORV.php">Orange</a></li>
