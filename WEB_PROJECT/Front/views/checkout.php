            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-xs-2 order-lg-12 mt-10 mb-10">
                    ...
                    <div class="header-account-links">
                        <a href="checkout.php"><i class="icofont icofont-user-alt-7"></i> <span><?php echo $_SESSION['uname']?></span></a>
                        <a href="logout.php"><i class="icofont icofont-logout d-none"></i> <span>Logout</span></a>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-lg-12 order-xl-12">
                    ...
                    <div class="header-shop-links">
                        ...
                        <!-- Compare -->
                        <a href="compare.php" class="header-compare"><i class="ti-control-shuffle"></i></a>
                        <!-- Wishlist -->
...
<input type="submit" value="Track order" >
    ...
    <div class="banner">
        ...
        <a href="compare.php" class="btn btn-large btn-circle mr-30 mb-30">check all your track <?php echo $_SESSION['uname'] ; ?></a>
