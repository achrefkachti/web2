...
<li class="slide">
                ...
                <!--aside closed-->
                        ...
                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Géstion Produit</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Produit</a></li>
								<li class="breadcrumb-item active" aria-current="page">Géstion Produit</li>
							</ol>
						</div>
						<!--page-header closed-->
