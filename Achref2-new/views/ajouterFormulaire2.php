                                                ...
                                                <ul class="horizontalMenu-list">
                                                    ...
                                                    <li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon active" > SAV <i class="fa fa-angle-down horizontal-icon"></i></a>
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li aria-haspopup="true"><a href="supprimerFormulaire1.php">Supprimer Formulaire</a></li>
...
<br /><br />
                    ...
                    <!--row open-->
                           ...
                           <div class="col-12">
                             <div class="card">
                               <div class="card-header">
                                 <h4>Vos Réclamations</h4>
                               </div>
                             <div class="card-body">
                                   <form class="form-horizontal" method="POST" action="ajouterFormulaire2.php">
                                    <div class="card-body">
