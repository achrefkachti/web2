										...
										<div class="horizontal-mainwrapper container clearfix">
											<nav class="horizontalMenu clearfix"><div class="overlapblackbg"></div>
												<ul class="horizontalMenu-list">
													...
													<li aria-haspopup="true"><a href="emptypage.php" class=""> HOME </a></li>
													...
													<!--<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon active" > SAV <i class="fa fa-angle-down horizontal-icon"></i></a>
														<ul class="sub-menu">
															...
															<li aria-haspopup="true"><a href="ajouterFormulaire.php">Ajouter Réclamation</a></li>
															<li aria-haspopup="true"><a href="supprimerFormulaire.html">Supprimer Réclamation</a></li>
						...
						<div class="row">
							...
							<div class="row">
											...
											<div id="accordion">
												...
												<div class="accordion">
													<div class="accordion-header " data-toggle="collapse" data-target="#panel-body-2">
														<h4>Quel est le délai de retour chez Ariana Scooters ?</h4>
													</div>
       			            ...
       			            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  - Si ce délai est dépassé, nous n’acceptons malheureusement plus les retours.
       										                Nous vous invitons à regarder si votre produit possède une garantie. 
													</div>
												</div>
												<div class="accordion mb-0">
													<div class="accordion-header" data-toggle="collapse" data-target="#panel-body-3">
														<h4>Quelles sont les conditions pour retourner un produit et quelle est la procédure ?</h4>
													</div>
													<div class="accordion-body collapse border border-top-0" id="panel-body-3" data-parent="#accordion">
														Prérequis pour une demande de retour valide:</br>
											  &nbsp&nbsp   Produit éligible au retour (ne peuvent pas être retournés ...),vérifier  
											               l'éligibilité de votre produit au retour avec le service client Jumia.</br>
    		 							...
    		 							&nbsp&nbsp		   Condition physique du produit en accord avec la raison de retour.</br></br>
														...
														Tout produit sera sujet à un examen.</br>
														   Si l’examen s’avère positif, nous vous rembourserons selon le mode choisi ( Bon d’achat ou virement).Vous serez remboursé dans 72H de la date de fin d'examen par le service qualité Ariana Scooters.</br>
