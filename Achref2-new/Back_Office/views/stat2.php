...
$query ="SELECT catg, date, sum(quant) FROM formulaire group by catg, date, quant order by sum(quant), date";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          {
          //echo "['".$row['date']."', '".$row['catg']."'],";
          echo "['".$row['date']."', '".$row['catg']."', '".$row['sum(quant)']."'],";
          }
        ...
        var options = {
          chart: {
            title: 'Stats Réclamation',
            subtitle: 'date, catg, quant',
          }
        };
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <div class=" dropdown-header noti-title text-center border-bottom pb-3">
                  ...
                  <small class="text-overflow m-0"> College-Studentr</small>
                </div>
        ...
        <div class="app-content">
          <section class="section">
            ...
            <div class="page-header">
              <h4 class="page-title">Statistique SAV</h4>
              <ol class="breadcrumb">
