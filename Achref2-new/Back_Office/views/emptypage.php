											...
											<nav class="horizontalMenu clearfix"><div class="overlapblackbg"></div>
												<ul class="horizontalMenu-list">
													...
													<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon "> PRODUITS <i class="fa fa-angle-down horizontal-icon"></i></a>
														<ul class="sub-menu">
															<li aria-haspopup="true"><a href="#">Show Room</a></li>
															<li aria-haspopup="true"><a href="#">P.R Scooter</a></li>
															<li aria-haspopup="true"><a href="#">P.R Vélo</a></li>
															<li aria-haspopup="true"><a href="#">Accessoires</a></li>
														</ul>
													</li>																								
													...
													<li aria-haspopup="true"><a href="panier.html" class=""> PANIER </a></li>
