...
$listeClients=$client1C->triertabclients();
...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM clients WHERE CONCAT(id, username, nom, prenom, adresse, telephone, password) LIKE '%".$valueToSearch."%'";
...
-->                    <div  align="right" >
												...
												<a class="btn btn-primary buttons-pdf buttons-html5" href="pdfclient.php" tabindex="0" aria-controls="example" type="button" target="_blank"><span>PDF</span></a>
												<br><br>
											
											</div>
											<div  >
												
												<a class="btn btn-primary buttons-pdf buttons-html5"  type="button" ><span>Tri </span></a>
												<br><br>
