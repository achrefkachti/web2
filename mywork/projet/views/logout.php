...
<!-- Mirrored from demo.devitems.com/ee/ee-v1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Apr 2019 18:44:23 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <li class="active menu-item-has-children"><a href="index.html">HOME</a>
                                    <ul class="mega-menu two-column">
                                        <li><a href="#" class="d-none">Home Light</a>
                                            <ul>
                                                <li class="active"><a href="index.html">Home One Light</a></li>
                                        ...
                                        <li><a href="#" class="d-none">Home Dark</a>
                                            <ul>
                                                <li><a href="index-dark.html">Home One Dark</a></li>
                                                <li><a href="index-2-dark.html">Home Two Dark</a></li>
                                                <li><a href="index-3-dark.html">Home Three Dark</a></li>
                                                <li><a href="index-4-dark.html">Home Four Dark</a></li>
                                                <li><a href="index-5-dark.html">Home Five Dark</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="hero-slider hero-slider-one">
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="hero-image col">
                               <img src="assets/images/hero/1.jpg" id="taswira"  alt="Hero Image">
                            </div>
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                               <img src="assets/images/hero/2.jpg" id="taswira" alt="Hero Image">
                            </div>
                            <div class="hero-content col">
                    ...
                    <div class="hero-item">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <!-- Hero Image -->
                            <div class="hero-image col">
                               <img src="assets/images/hero/3.jpg"  id="taswira" alt="Hero Image">
                            </div>
                            <div class="hero-content col">
    ...
    <div class="container">
        <div class="row row-10">
            ...
            <div class="col-md-8 col-12 mb-30">
                <div class="banner"><a href="#"><img id="pub"src="assets/images/banner/banner-2.jpg" alt="Banner"></a></div>
            </div>

            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img id="pub" src="assets/images/banner/banner-5.jpg" alt="Banner"></a></div>
            </div>
                ...
                <div class="col mb-90">
                    <div class="footer-widget text-center">
                        <div class="footer-logo">
                            <img src="assets/images/log.png" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
                    <!--        <img class="theme-dark" src="assets/images/log.png" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template"> -->
                        </div>
...
<div class="popup-subscribe-section section bg-gray pt-55 pb-55" data-modal="popup-modal">
    ...
    <div class="popup-subscribe-wrap">
        ...
        <div class="popup-subscribe-banner banner">
            <a href="#"><img src="assets/images/banner/banne.jpg" alt="Banner"></a>
        </div>
...
<!-- Mirrored from demo.devitems.com/ee/ee-v1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Apr 2019 18:45:29 GMT -->
</html>
