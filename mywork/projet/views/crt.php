...
if (isset($_SESSION['username'])){
  $clientC=new carteC();
    $result=$clientC->recupererCarte($_SESSION['username']);
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">
                    ...
                    <form  name="f" method="POST" action="ajoutcarte.php">
                        <div class="row">
                            <div class="col-12 mb-30"><input type="text" placeholder="nom d'utilisateur" name="username" value="<?PHP echo $_SESSION['username'] ?>" ></div>
                            <div class="col-12 mb-30"><input type="text" placeholder="nom" name="nom" onblur="verifnom(this)" required></div>
                            <div class="col-12 mb-30"><input type="text" placeholder="prenom" name="prenom" onblur="verifnom(this)" required></div>
                            <div class="col-12 mb-30"><input type="number" placeholder="CIN" name="cin" onblur="verifcin(this)" required></div>
                            <input type="hidden" name="confirme" value="0">
                          <div class="col-12"><input  type="submit" value="Envoyer "></div>  
                        </div>
                    </form>
