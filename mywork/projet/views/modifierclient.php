...
?>
                 ...
                 <div class="col-12 mb-30"><input type="number"  name="telephone"  value="<?PHP echo $telephone ?>" onblur="veriftelephonee(this)" required></div>
                            <div class="col-12 mb-30"><input type="text"  name="adresse"  value="<?PHP echo $adresse ?>" onblur="verifMail(this)" required></div>
                            <div class="col-12 mb-30"><input type="password"  name="password" value="<?PHP echo $password ?>" onblur="verifPass(this)" required></div>
