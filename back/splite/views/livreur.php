...
<head>
	...
	<form  class="form-horizontal" method="GET" action="ajouter_personne.php" id="form" >
											<div class="form-group row">
												...
												<div class="col-md-9">
							<input class="form-control"  id="nom" type="text" name="nom" onblur="verifnom(this);">
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
	<input class="form-control" type="text" id="mail" name="mail" onblur="verifmail(this);">
												</div>

											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label" >date de naissance</label>
												<div class="col-md-9">
                               		...
                               		<div class="form-group row">
												...
												<div class="col-md-9">
										<input class="form-control" type="tel" name="tel" onblur="veriftel(this); "id="tel">
												</div>
											</div>
	  ...
	  <button  type="submit" class="btn btn-primary mt-1 mb-0 ">Submit</button>
										...
										<p style="color: red" id="erreur" > erreur </p>
...
foreach($listeEmployes as $row){
	?>
			...
			<input type="submit" class="btn btn-danger btn-rounded btn-sm my-0"  value =  "supprimer" name="supprimer">
                      <input type="hidden" value ="<?php echo $row['mail']; ?>" name="mailc">
														</span>
													</form>
													</td>

													<td>
														<span> <a href="formwizard.php?tel=<?php echo $row['tel']; ?>" > </a>

				<input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="" value="modifier">
</span>
													</td>
												</tr>
