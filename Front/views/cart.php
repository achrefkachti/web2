                                 ...
                                 <?php 
                                                    ...
                                                    foreach( $listepanier as $row )
                                                        { 
                                                            ...
                                                            ?>
                                <tr>
                                    <td class="pro-thumbnail"><img src="<?php echo $row['img']; ?>" alt="Product"></td>
                                    ...
                                    <td >
                                     <form method="POST" action="supprimerprod.php">
                                        <input type="submit" class="btn btn-small btn-circle hover-theme mb-30" name="" value="Supprimer">
                    ...
                    <div class="col-lg-6 col-12 mb-15">
                        ...
                        <div class="discount-coupon">
                            ...
                            <form method="POST">
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-25">
                                        <input type="text" name="nomc" placeholder="Coupon Code">
                                    </div>
                                    <div class="col-md-6 col-12 mb-25">
