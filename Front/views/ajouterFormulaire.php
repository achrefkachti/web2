       ...
       <form class="comment-form" method="POST" action="ajoutFormulaire.php" onsubmit="return envoyer()">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 mb-30">
                                    ...
                                    <input type="text" id="Prenom" placeholder="Prenom" name="prenom" onblur="verifnom(this)" value="<?php echo $_SESSION['r']; ?>" readonly>
                                </div>
                                
                                <div class="col-md-6 col-12 mb-30">
                                    <label for="email_address">EMAIL</label>    
                                    <input type="email" id="Email"  placeholder="Email" value="<?php echo $_SESSION['l']; ?>" name="email" onblur="verifMail(this)" readonly>
                                </div>
