...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join categorie c  ON  p.refe= c.refe AND c.affichage='oui' AND p.type='piéces de rechange'";
    $search_result = filterTable($query);
}
                                ...
                                <li class="menu-item-has-children"><a href="shop.php">Shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class=""><a href="accesoires.php">Accessoires</a>
                                         ...
                                         <li class=""><a href="pieces.php">Piéces de rechange</a>
                                        </li>
                        ...
                        <div class="shop-top-bar with-sidebar">
                         ...
                         <div class="product-short">
                                ...
                                <select name="sortby" class="nice-select"  onChange="location.href=''+this.options[this.selectedIndex].value+'.php';">
                                    ...
                                    <option value="ratingp">Best rated</option>
                                    <option value="triascp">Price: low to high</option>
                                    <option value="tridescp">Price: high to low</option>
                                </select>
                            </div>
