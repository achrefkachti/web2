...
if (isset($_GET['refe'])){
    ...
    $result=$categorieC->recupererCategorie($_GET['refe']);
...
?>
										...
										<div class="form-group row">
												...
												<div class="col-md-9">
													<textarea rows="4" cols="103" name="description"  value="<?PHP echo $description?>"  >
...
-->
											<div class="form-group row">
												...
												<div class="col-md-9">
													<select class="form-control" name="affichage" value="<?PHP echo $_GET['affichage']?>">
														<option>oui</option>
														<option>non</option>
...
if (isset($_POST['modifier'])){
	$categorie=new categorie( $_POST['refe'],$_POST['description'],$_POST['affichage'] );
	$categorieC->modifierCategorie($categorie,$_POST['refe_ini']);
  echo "<META http-equiv='refresh' content='0;URL=categorieprinc.php'>";
}
?>
