...
?>
										<form class="form-horizontal" method="POST" >
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<select class="form-control" name="marque" value="<?PHP echo $marque?>">
...
if (isset($_POST['modifier'])){
	$produit=new produit( $_POST['nom'],$_POST['refe'],$_POST['couleur'],$_POST['type'],$_POST['marque'],$_POST['quantite'],$_POST['prix'],$_POST['img'] );
