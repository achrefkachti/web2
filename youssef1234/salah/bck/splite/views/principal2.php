			...
			<div class="main-wrapper" >
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="nav-link pl-1 pr-1 leading-none ">
                            <img src="pdp.jpg" alt="pdp.jpg" class="avatar-xl rounded-circle mb-1">
                ...
                <ul class="side-menu">
                  ...
                  <li class="slide ">
                   ...
                   <ul class="side-menu">
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="principal.php"><i class="side-menu__icon fa fa-folder-open-o"></i><span class="side-menu__label">Gestion Produits</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="stat.php"><span>Stat Produits </span></a></li>
