			...
			<div class="main-wrapper" >
                ...
                <ul class="side-menu">
                  ...
                  <li class="slide ">
                   ...
                   <ul class="side-menu">
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="principal.php"><i class="side-menu__icon fa fa-folder-open-o"></i>
                        	<span class="side-menu__label">Gestion Produits</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu">
