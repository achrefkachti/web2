...
function afficherProduit ($produit){
	...
	function ajouterProduit($produit){
		$sql="insert into produit(nom,refe,couleur,type,marque,quantite,prix,img) values (:nom,:refe,:couleur,:type,:marque,:quantite,:prix,:img)";
	...
	function modifierProduit($produit,$refe){
		$sql="UPDATE produit SET  nom=:nom, refe=:refee,couleur=:couleur,type=:type,marque=:marque,quantite=:quantite ,prix=:prix,img=:img  WHERE refe=:refe";
...
try{		
		...
		$datas = array(':nom'=>$nom, ':refee'=>$refee, ':refe'=>$refe,':couleur'=>$couleur,':type'=>$type,':marque'=>$marque,':quantite'=>$quantite,':prix'=>$prix,':img'=>$img);
		$req->bindValue(':nom',$nom);
