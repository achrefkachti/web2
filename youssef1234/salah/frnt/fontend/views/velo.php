...
$listeProduits4=$produit1C->afficherProduits4();
							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<ul class="nav prod-cat">
												<li>
													<a href="scooter.php" class="active"><i class=" fa fa-angle-right"></i> Les 2 roues</a>
													<ul class="nav">
														<li ><a href="scooter2.php">- Scooter</a></li>
														<li class="active"><a href="velo.php">- Velo</a></li>
														
													</ul>
												</li>

												<li><a href="accesoires.php"><i class=" fa fa-angle-right"></i> Accessoires</a></li>
								...
								<div class="col-md-12 col-lg-8 col-xl-9">
									...
									<div class="row product-list">
										<?php foreach ($listeProduits4 as $row ) {?>
										<div class="col-lg-6 col-xl-4 col-md-6">
										    <div class="card">
										    												<a href="product-detail.php?id=<?php echo $row['refe'] ?>">
