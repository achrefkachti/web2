                                        ...
                                        <div class="horizontal-mainwrapper container clearfix">
                                            <nav class="horizontalMenu clearfix"><div class="overlapblackbg"></div>
                                                <ul class="horizontalMenu-list">
                                                    ...
                                                    <li class="active" aria-haspopup="true"><a href="panierFE.php" > PANIER </a></li>



                                                    <li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon " > SAV <i class="fa fa-angle-down horizontal-icon"></i></a>
                                                        <ul class="sub-menu">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Cart Subtotal</td>
                                                                <td class="text-right"><?php echo $extot ?></td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <input class="btn btn-primary mt-2" type="submit" name="payer"  value="Payer">
                                                    <input class="btn btn-success mt-2" type="submit" value="Continuer le Shopping">
                                                </form>
