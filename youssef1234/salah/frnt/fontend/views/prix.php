...
$listeProduits8=$produit1C->afficherProduits8();
...
{
    $connect = mysqli_connect("localhost", "root", "", "produit");
										...
										<div class="card-body sliders">
											<div class="">
												<div class="radio">
													...
													<label for="shop-filter-price_1">Moins de 1400 dt</label><a href="prix.php"></a>
												</div>
												<div class="radio">
								    ...
								    <div class="card">
										...
										<div class="card-body">
											<div class="input-group">
												...
												<input type="text" name="valueToSearch" class="form-control btl-2 bbl-2" placeholder="Value To Search">
												<div class="input-group-append">
													
													<input class="btn btn-primary btr-2 bbr-2 text-center mb-0" type="submit" name="search" value="Search">
												</div>
											</div>
										</div>
									</form>
