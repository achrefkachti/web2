...
$listeProduits7=$produit1C->afficherProduits7();
session_start();
...
<div class="section-body ">
							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<ul class="nav prod-cat">
												<li>
													<a href="scooter.php" ><i class=" fa fa-angle-right"></i> Les 2 roues</a>
													<ul class="nav">
														<li ><a href="scooter2.php">- Scooter</a></li>
														<li><a href="velo.php">- Velo</a></li>
														
													</ul>
												</li>

												<li><a href="accessoires.php" class="active"><i class=" fa fa-angle-right"></i> Accessoires</a></li>
								...
								<div class="col-md-12 col-lg-8 col-xl-9">
									...
									<a href="detail.html"><div class="row product-list">
										<?php foreach ($listeProduits7 as $row ) {?>
										<div class="col-lg-6 col-xl-4 col-md-6">
										    <div class="card">
												<a href="detail.php?id=<?PHP echo $row['refe']; ?>"><td><img width="400" height="400" src=" <?PHP echo $row['img'];?>" > </td></a>
