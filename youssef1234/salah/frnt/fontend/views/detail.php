...
$listeProduits5=$produit1C->afficherProduits5();
session_start();
												...
												<form class="form-inline">
													<div class="search-element mr-3">
														...
														<span class="Search-icon"><i class="fa fa-search"></i></span>
																									...
																									<a href="login.html" class="btn btn-lg btn-primary m-b-5 m-t-5"></a>
																									<?php 
...
if (isset($_GET['refe'])){
    ...
    $result=$produit1C->recupererProduit($_GET['refe']);
...
?>
										...
										<div class="text-center mt-4">
											<a href="shop-cart.html" class="btn btn-lg btn-primary mt-1 mb-1"><i class="fa fa-shopping-cart"></i> Add to cart</a>
										...
										<div class="mt-4 product-spec">
																			<?php
		$bdd = new PDO('mysql:host=127.0.0.1;dbname=produit;charset=utf8','root','');
 ...
 if( isset ($_SESSION['r']) ){
      ...
      if(isset($_POST['commentaire'])  AND !empty($_POST['commentaire'])) {
         ...
         $commentaire = htmlspecialchars($_POST['commentaire']);
            ...
            $ins->execute(array($_POST['commentaire'],$_SESSION['r']));
            $c_msg = "<span style='color:green'>Votre commentaire a bien été posté</span>";
            echo "< META http-equiv='refresh' content='0;URL=scooter.php'>";
   ...
   ?> 
                                    <div class="form-group row">
												...
												<div class="col-md-9">
													...
													&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<form method="POST">
														<textarea rows="4" cols="103" name="commentaire"  >
            
													</textarea>
</form>
												</div>
												&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-success mt-2" type="submit"  name="submit_commentaire">
											</div>	
...
<?php } ?>
							...
							<div class="col-xl-4 col-lg-12 col-md-12">
								...
								<div class="card Relatedpost">
									...
									<div class="card-body">
										<?php foreach ($listeProduits5 as $row ) {?>
