...
?>
										<form class="form-horizontal" method="POST" >
											<div class="form-group row">
												<label class="col-md-3 col-form-label">ID Panier</label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php echo $idp ?>" name="idp" onblur="verifref(this);" readonly>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom Client </label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php echo $nomcl ?>" name="nomcl" onblur="verifref(this);" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">ID Client </label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php echo $idcl ?>" name="idcl" onblur="verifnom(this);" readonly>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<select class="form-control" name="nomprod" value="<?php echo $nomprod ?>">
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="number" class="form-control" name="quantite" value="<?php echo $quantite ?>" onblur="verifrefe(this);">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" name="prix" value="<?php echo $prix ?>" onblur="verifrefe(this);">
												</div>
											</div>

										
											
													<button type="submit" value="modifier" name="modifier" class="btn btn-primary mt-1 mb-0">Modifier Produit</button>
													<input type="hidden" name="idpp" value="<?PHP echo $_GET['idcl'];?>">
...
if (isset($_POST['modifier'])){
	...
	$panierC->modifierpanier($panier,$_POST['idpp']);
												...
												<?php 
													foreach( $listepanier as $row )
														...
														<tr>
															...
															<td>
														<span > <a href="modifierpanier.php?idp=<?PHP echo $row['idp']; ?>"><input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="" value="Modifier"></a>
														</span>
												...
												<table class="table table-bordered">
													<tbody>
														...
														<tr>
															...
															<td><h2 class="price text-right"><?php echo $tot ?></h2></td>
														</tr>
													</tbody>
												</table>
											</div>
