							...
							<section class="section">
										...
										<div class="card">
												...
												if (isset($_GET['idl'])){
													$LivreurC=new LivreurC();
														$result=$LivreurC->getname($_GET['idl']);
										...
										<form class="form-horizontal" method="POST">
											<div class="form-group row">
												<label class="col-md-3 col-form-label" > Idl </label>
												<div class="col-md-9">

													<input class="form-control" type="text" name="idl" value="<?php echo $idl; ?>" readonly>
												</div>
											</div>
<div class="form-group row">
							      	...
							      	<input type="hidden" name="idll" value="<?PHP echo $idl; ?>">
...
<?php
 ...
 {
	$Livreur=new Livreur($_POST['nom'],$_POST['mail'],$_POST['tel'],$_POST['permis'],$_POST['dateA']);
	$LivreurC->modifierlivreur($Livreur,$_POST['idll']);
//	var_dump($LivreurC->modifierlivreur($Livreur,$_POST['idll']));
