...
if(isset($_POST['search']))
{
    ...
    { $min = $_POST['min'];
 $max = $_POST['max'];
    $query = "SElECT * From produit where prix between '$min' AND '$max' and categorie='scooter' ";
    $search_result = filterTable($query);
}
else  {
...
{
    var zip = parseInt(champ.value);
   if(isNaN(zip) || zip <1001 || zip >=5001)
   {
      surligne(champ, true);
      return false;
   }
                            ...
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a href="shop.php">Shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class=""><a href="pieces.php">Piéces de rechange</a></li>
