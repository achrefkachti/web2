                ...
                <div class="col order-12 order-xs-12 order-lg-2 mt-10 mb-10">
                    ...
                    <div class="header-advance-search">
                        ...
                        <form method="GET" action="recherche_galerie.php">
                            <div class="input"><input type="text" placeholder="Chercher photo" name="search"></div>
...
<!-- Blog Section Start -->
<div class="blog-section section mt-90 mb-90">
    <div class="container">
...
<div class="page-header">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" style="color:darkblue;">Commentaires</a></li>
                            </ol>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <p style="color:darkblue;"><?PHP echo $row['utilisateur']; ?></p>
                                        </div>
