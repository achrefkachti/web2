...
$listeliv= $Livraison1C->afficherLivraisonclient($_SESSION['uname']);
	?>
<!doctype html>
            ...
            <div class="page-banner">
                ...
                <div class="breadcrumb">
                    <ul>
                        <li><a href="#">HOME</a></li>
                        <li><a href="#">Shop</a></li>
                        <li><a href="checkout.php">Livraison</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="compare-table table-responsive">
                        <table class="table mb-0">
                            <tbody>
                              ...
                              <th class="first-column"> ID Livraison </th>
                              <th class="first-column"> Username </th>

                         <th class="first-column">nom </th>
                          <th class="first-column">E-mail</th>
                          <th class="first-column">Tel</th>
                          <th class="first-column">town</th>
                          <th class="first-column">state</th>
                          <th class="first-column">zip</th>

                          <th class="first-column">etat</th>
...
foreach($listeliv as $row){
	...
	<tr>
                         ...
                         <th><?php echo $row['nomC']; ?></th>
                    			<th><?php echo $row['mailC']; ?></th>
													<th><?php echo $row['telC']; ?></th>
													<th><?php echo $row['town']; ?></th>
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-40">
                    <div class="footer-widget">
                        ...
                        <ul class="link-widget">
                            ...
                            <li><a href="checkout.php"><?php $_SESSION['uname'] ?></a></li>
                            <li><a href="#">Cart</a></li>
