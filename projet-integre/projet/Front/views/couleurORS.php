...
if(isset($_POST['search']))
{
    ...
    $query = "SElECT * From produit p inner join categorie c  ON  p.refe= c.refe and c.affichage='oui' and p.couleur='Orange' and p.categorie='scooter'";
    $search_result = filterTable($query);
}
            ...
            <div class="shop-sidebar-wrap col-xl-3 col-lg-4 col-12 order-lg-1 mb-15">
                ...
                <div class="shop-sidebar mb-35">
                  ...
                  <ul class="sidebar-brand">
                       <li><a href="couleurBLS.php">Blanc</a></li>
                        <li><a href="couleurBS.php">Bleu</a></li>
                        <li><a href="couleurRS.php">Rouge</a></li>
                        <li><a href="couleurNS.php">Noire</a></li>
                        <li><a href="couleurORS.php">Orange</a></li>
