...
<?php
$dbhandle =new mysqli('localhost','root','','produit');
echo $dbhandle->connect_error;

$query ="SELECT couleur, sum(quantite) FROM produit group by couleur ";
...
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        {
          echo "['".$row['couleur']."',".$row['sum(quantite)']."],";
          }
          ?>
        ]);
          ...
          <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
                <span class="mr-3 mt-2 d-none d-lg-block ">
                  <span class="text-white">Hello,<span class="ml-1"> Youssef Ghedas</span>
                </span>
