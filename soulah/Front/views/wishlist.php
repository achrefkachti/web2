                    ...
                    <div class="cart-table table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img src="<?php echo $row['img']; ?>" alt="Product"></a></td>
                                    <td class="pro-title"><a href="#"><?php echo $row['nomprod']; ?></a></td>
                                    ...
                                    <td class="pro-remove">
                                        ...
                                        <button type="submit" class="btn btn-medium btn-circle mr-0 mb-0"><i class="fa fa-trash-o"></i></button>
                                        <input type="hidden" value="<?php echo $row['idw']; ?>" name="sup">
