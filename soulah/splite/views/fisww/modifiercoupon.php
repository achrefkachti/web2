...
?>
										<form class="form-horizontal" method="POST" >
											<div class="form-group row">
												...
												<div class="col-md-9">
												<input type="text" class="form-control" readonly onblur="verifnom(this);" name="idc" value="<?PHP echo $idc ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom du Coupon </label>
												<div class="col-md-9">
													<input type="text" class="form-control" onblur="verifref(this);" name="nomc" value="<?PHP echo $nomc?>"  >
												</div>
											</div>
											<div class="form-group row">
