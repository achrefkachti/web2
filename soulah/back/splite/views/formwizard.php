						...
						<div class="page-header">
							...
							if (isset($_GET['tel'])){
								$LivreurC=new LivreurC();
									$result=$LivreurC->getname($_GET['tel']);
									...
									<div class="col-md-9">
										<select class="form-control" name="permis" value="<?php echo $permis; ?>">
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input class="form-control" type="date" value="<?php echo $dateA; ?>" name="dateA">
												</div>
											</div>

											<button type="submit" class="btn btn-primary mt-1 mb-0"  value="modifier" name="modifier"> modifier</button>
								<input type="hidden" name="tell" value="<?PHP echo $_GET['tel']; ?>">
...
<?php
	...
	$LivreurC->modifierlivreur($Livreur,$_POST['tel']);
